  ...
  const navLinks = [
    {
      ...
      path: '/services',
      dropdown: [
        { title: 'Primary Care', path: '/services/primary-care' },
        { title: 'Specialized Treatments', path: '/services/specialized-treatments' },
        { title: 'Emergency Care', path: '/services/emergency-care' },
    ...
    },
    {
      ...
      path: '/physicians',
      dropdown: [
        { title: 'Meet Our Doctors', path: '/physicians' },
        { title: 'Specialties', path: '/physicians?filter=specialties' },
        { title: 'Patient Success Stories', path: '/physicians?filter=success-stories' }
      ]
    },
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/#contact" className={`flex items-center ${isScrolled ? 'text-primary-600' : 'text-white'}`}>
              <FaPhone className="mr-2" />
              <span>1-800-DRBUDDY</span>
            </Link>
            <Link to="/#schedule" className="btn-primary flex items-center">
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            <div className="flex items-center justify-center">
              <Link to="/#contact" className={`flex items-center px-3 py-2 rounded-md text-base font-medium ${isScrolled ? 'text-primary-600' : 'text-white'}`}>
                <FaPhone className="mr-2" />
                <span>1-800-DRBUDDY</span>
              </Link>
            </div>
            <div className="mt-3 flex justify-center">
              <Link to="/#schedule" className="btn-primary flex items-center text-center justify-center w-full mx-3">
                <FaCalendarAlt className="mr-2" />
                <span>Schedule Appointment</span>
              </Link>
            </div>
